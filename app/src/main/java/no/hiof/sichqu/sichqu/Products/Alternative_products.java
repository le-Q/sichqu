...
public class Alternative_products
{
    ...
    {
        return "ClassPojo [gross_unit_price = "+gross_unit_price+", client_classifiers = "+client_classifiers+", unit_price_quantity_name = "+unit_price_quantity_name+", brand_id = "+brand_id+", unit_price_quantity_abbreviation = "+unit_price_quantity_abbreviation+", name_extra = "+name_extra+", id = "+id+", front_url = "+front_url+", gross_price = "+gross_price+", name = "+name+", brand = "+brand+", images = "+images+", category_items = "+category_items+", availability = "+availability+", full_name = "+full_name+"]";
    }
}
